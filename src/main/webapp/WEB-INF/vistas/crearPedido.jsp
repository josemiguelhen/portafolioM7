		...
		<div class="contacto" style="display: flex; justify-content: center;">
			...
			<form id="formularioCrearPedido"
				...
				<div class="form-group"
					...
					<label class="mb-3 col-md-12 mb-2 custom-label">Elige 
						tus productos a llevar y selecciona las cantidades:</label> <br>
					<div class="row">
				...
				<div class="form-group mt-5"
					style="margin-left: auto; margin-right: auto; display: table;">
					<label for="indicaciones">Indicaciones de envío (llamar a puerta, dejar en recepción, etc.):</label><br>
